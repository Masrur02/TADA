...
from dataset.common import imagenet_mean, imagenet_std, colors_voc, colors_rugd,colors_city
...
class DACS(UDADecorator):
    ...
    def get_pseudo_label_and_weight(self, logits):
        ...
        return pseudo_label, pseudo_weight,ema_trav
    ...
    def forward_train(self,
        ...
        clean_losses,src_logits,trav,trav_gt = self.get_model().forward_train(
        ...
        if not self.source_only:
            ...
            pseudo_label, pseudo_weight,ema_trav = self.get_pseudo_label_and_weight(
                ema_logits)
            del ema_logits,ema_trav
            ...
            mix_losses,mix_logit,mix_trav,mix_trav_gt = self.get_model().forward_train(
                mixed_img,
                img_metas,
                mixed_lbl,
        ...
        if self.enable_masking and self.mask_mode.startswith('separate'):
            masked_loss,masked_logit,masked_trav,masked_trav_gt = self.mic(self.get_model(), img, img_metas,
