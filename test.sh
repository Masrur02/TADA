...
TEST_ROOT=$1
CONFIG_FILE="/l/scratch/khanmdal/IJRR/TRAV/seg/work_dirs/local-basic/TRAV_CITY/a.py"  # or .json for old configs
CHECKPOINT_FILE="/l/scratch/khanmdal/IJRR/TRAV/seg/work_dirs/local-basic/TRAV_CITY/iter_40000.pth"
SHOW_DIR="/l/scratch/khanmdal/IJRR/TRAV/seg/work_dirs/local-basic/TRAV_CITY/preds"
